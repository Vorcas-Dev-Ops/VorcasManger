...
class TlScheduleScreen extends ConsumerStatefulWidget {
  const TlScheduleScreen({super.key});

  @override
  ConsumerState<TlScheduleScreen> createState() => _TlScheduleScreenState();
}

class _TlScheduleScreenState extends ConsumerState<TlScheduleScreen> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TlScheduleFormScreen(initialDate: _selectedDay),
            ),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            const Text('No squad events for this day',
