...
class _EmpProfileScreenState extends ConsumerState<EmpProfileScreen> {
  ...
  Future<void> _pickImage() async {
    ...
    try {
      ...
      // If gallery failed or was canceled, try to show a choice or just log
      if (image == null) {
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    if (!_isEditing && user != null) {
                      // Sync controllers with current user data when entering edit mode
