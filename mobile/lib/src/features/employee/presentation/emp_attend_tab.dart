...
class EmpAttendTab extends ConsumerStatefulWidget {
  const EmpAttendTab({super.key});

  @override
  ConsumerState<EmpAttendTab> createState() => _EmpAttendTabState();
}

class _EmpAttendTabState extends ConsumerState<EmpAttendTab> {
  late Timer _timer;
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: highlight ? const Border(left: BorderSide(color: SuperAdminTheme.primaryOrange, width: 4)) : null,
      ),
      padding: const EdgeInsets.all(16),
      child: Column(
        ...
        children: [
           Text(title, style: const TextStyle(color: SuperAdminTheme.textSecondary, fontSize: 9, fontWeight: FontWeight.bold, letterSpacing: 1.0)),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(day, style: const TextStyle(color: SuperAdminTheme.textSecondary, fontSize: 8, fontWeight: FontWeight.bold, letterSpacing: 1.0)),
              ],
            ),
          ),
          Expanded(flex: 2, child: Text(clockIn, style: const TextStyle(color: Colors.white, fontSize: 12))),
          Expanded(flex: 2, child: Text(clockOut, style: const TextStyle(color: Colors.white, fontSize: 12))),
          Expanded(flex: 2, child: Text(total, style: const TextStyle(color: SuperAdminTheme.primaryOrange, fontSize: 12, fontWeight: FontWeight.bold))),
        ],
      ),
    );
  }
